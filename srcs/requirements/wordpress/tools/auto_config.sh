...
if ! wp core is-installed --allow-root ; then
    ...
    wp post create /tmp/inception.txt --post_title="Best quotes from Inception" --post_content="Here is the best quotes from Inception." --post_status=publish --post_author=Bob  --allow-root
